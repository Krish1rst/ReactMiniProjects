...
function Form() {
    ...
    return (
        <article className="flex flex-col gap-2 justify-center items-center pt-24 bg-slate-400">
            ...
            <section className='bg-slate-300 w-64 rounded-2xl flex justify-center items-center p-2'>
